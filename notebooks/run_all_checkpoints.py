...
if __name__ == "__main__":
    ...
    for idx in range(0, len(checkpoints)):
        ...
        try:
            with open(
                f"/usr/people/kundu/code/ann-rnn-modified/data/{train_run_id}/rnn_ann_model_results_10units_{checkpoint_number}.pkl",
                "wb",
            ) as f:
        ...
        filename = f"/usr/people/kundu/code/ann-rnn-modified/data/{train_run_id}/bayesian_results_10units_{checkpoint_number}.pkl"
        try:
